...
def main(llm_name):
    ...
    hf_emb = pd.read_csv(f'../../Dataset/Raw_Embeddings/AirBnB_Embeddings_with_name_mon.csv')   # raw 버전용
    ...
    for key, df in group:
        ...
        # raw 버전용
        gcn_path = f"../../Dataset/GCN_Embeddings/GCN_AirBnB_raw_Embeddings.csv"
        gat_path = f"../../Dataset/GCN_Embeddings/GAT_AirBnB_raw_Embeddings.csv"
