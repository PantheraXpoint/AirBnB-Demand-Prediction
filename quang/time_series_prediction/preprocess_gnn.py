...
dataframe2 = pd.read_csv('Dataset/Final_Embeddings/all_raw_gcn.csv') 
...
matrix_without_headers.to_csv('quang/time_series_prediction/main_experiments/gnn_embeddings/all_raw_gcn.csv', index=False, header=False)

print("Processing complete. The final matrix is saved as 'all_raw_gcn.csv'.")
