...
def load_data(embeddings_path, labels_path):
    ...
    raw_embeddings = raw_embeddings.reshape(67, 424, 93)
...
if __name__ == "__main__":
    embeddings_path = 'quang/time_series_prediction/main_experiments/gnn_embeddings/all_raw_gcn.csv'
